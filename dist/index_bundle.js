...
/***/ function(module, exports, __webpack_require__) {
	...
	ReactDOM.render(React.createElement(App, { clientId: AUTH0_CLIENT_ID, domain: AUTH0_DOMAIN }), document.getElementById('login-page'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(147);
	var LoggedIn = __webpack_require__(160);
	  ...
	  render: function render() {
	    if (this.state.profile) {
	      return React.createElement(
	        ...
	        React.createElement(
	          'button',
	          { onClick: this.callApi, className: 'btn btn-lg btn-primary' },
	          'Call API'
	        )
	      );
	    } else {
	...
	module.exports = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement('img', { src: 'https://i.cloudup.com/StzWWrY34s.png' }),
	      React.createElement(
	        'h3',
	        null,
	        'Infy NMC Recruitment System'
	      ),
	      React.createElement(
	        'a',
